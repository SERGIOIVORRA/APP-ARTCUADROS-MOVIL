const SHOP_URL = window.AC_SHOP_URL || 'https://artcuadros.com';
...
function showInstallBanner() {
  ...
  if (isIos) {
    installIosHelp.classList.remove('hidden');
  } else {
    const androidHelp = document.getElementById('install-android-help');
    if (androidHelp) androidHelp.classList.remove('hidden');
  }
}
